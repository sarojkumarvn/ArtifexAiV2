  ...
  const generateBotResponse = async (prompt, imageBase64) => {
    ...
    try {
      ...
      setHistory((prevHistory) => {
        ...
        return [
          ...newHistory,
          { sender: "bot", message: "Sorry, I couldn't analyze that image. Please try again." },
        ];
      });
    } finally {
      setLoading(false);
              ...
              `}
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <button className="text-gray-400">{chat.icon}</button>
                  </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <form onSubmit={handleUserInput} className="relative">
            <div className="flex items-center bg-white border border-gray-300 rounded-lg pl-4 pr-1 py-1">
              ...
              <div className="relative">
                ...
                >
                  ...
                  >
                    <img
                      className="w-10 hover:bg-gray-300 rounded-full p-1"
                      src="./src/assets/imageUpload.svg"
                      alt="Upload"
                    />
                  </button>
                  {/* File input system */}
            ...
            <p className="text-xs text-gray-500 mt-2">
              Please upload an image and add a prompt to analyze it. Both are required.
            </p>
