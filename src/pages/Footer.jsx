...
const Footer = () => {
  return (
    <footer id="footer" className="bg-white py-12 border-t border-gray-200">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo and company info */}
          <div className="col-span-1">
            <div className="flex items-center mb-4">
              <span className="text-indigo-600 font-semibold text-2xl">Artifex AI</span>
            </div>
            <p className="text-gray-600 mb-4">Transform your AI experience with our powerful platform.</p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-500 hover:text-indigo-600 transition-colors" target="_self">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors" target="_self">Home</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors" target="_self">Features</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors" target="_self">Pricing</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors" target="_self">About Us</a></li>
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors" target="_self">Contact</a></li>
            </ul>
          </div>
